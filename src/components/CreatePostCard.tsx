...
type ContractorRecordType =
    | 'Добавление товарно-транспортной накладной'
    | 'Выполнение работ'
...
type SupervisionRecordType =
    ...
    | 'Подтверждение исправления замечаний'
    | 'Отклонение исправления замечаний';

type InspectorRecordType =
    | 'Инициирование лабораторного отбора'
    | 'Добавление нарушения'
    | 'Подтверждение исправления нарушения'
    | 'Отклонение исправления нарушений';
